...
import 'package:sytiamo/custom_widget/sy_page_state_widget.dart';
import 'package:sytiamo/utils/page_state_enum.dart';

class SYScaffold extends StatefulWidget {
  /// Extras:
  ...
  @override
  SYScaffoldState createState() => SYScaffoldState();
}

class SYScaffoldState extends State<SYScaffold> {
  ...
  void refreshState() {
    var state = SYScaffold.of(context);
    if (state != null) {
      state.refreshState();
    } else {
  ...
  Widget _buildAppBar(BuildContext context) {
    SYScaffoldState state = SYScaffold.of(context);

    PreferredSizeWidget appbar;
    SYAppBar ubAppBar = widget.appBar is SYAppBar ? widget.appBar : null;
